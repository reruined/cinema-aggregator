...
try {
  ...
  await Promise.allSettled([
    download('https://biografspegeln.se/webservices/show_times/getContent?cinema_id=1&content_id=6', './spegeln.json'),
    download('https://panora.internetbokningen.com/chap/ajax/getAllMovies', './panora.json')
  ])
}
catch(e) {
  console.error(e)
